...
export const ChallengeVinculacionView = () => {
  ...
  const sections = [
    ...
    },
    {
      ...
      title: 'Jueces asignados',
      description: 'Panel de seguimiento de jueces expertos que evaluarán las ideas del reto. Seguimiento de avance de calificación.',
      comingSoon: true,
    },
    {
      icon: (
    ...
    <Page>
      ...
      <SectionsGrid>
        {sections.map((section, index) => (
          <SectionCard key={section.title} $index={index}>
